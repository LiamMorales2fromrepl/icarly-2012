...
var flashUpdate = function() {
  ...
  flashUpdate.vars = {
    ...
    no_flash: 'hey, you don\'t have flash player. you\'re missing out on a lot of iCarly.com<br>\n',
    old_flash1: 'hey, you need to update from flash player ',
    old_flash2: ' to see everything on iCarly.com<br>\n',
  ...
  if (flash_version < 9)
  {
    ...
    if (os === 'mac') {   
      if (os_version >= 10.4)     
        install_url = 'https://github.com/ruffle-rs/ruffle/releases/download/nightly-2025-09-07/ruffle-nightly-2025_09_07-macos-universal.tar.gz'      
      ...
      if (window.ActiveXObject) {
        if (os_version >= 5.0)
          install_url = 'https://github.com/ruffle-rs/ruffle/releases/download/nightly-2025-09-07/ruffle-nightly-2025_09_07-windows-x86_32.zip'
        else if ((os_version > 0) && (flash_version < 9))
          install_url = 'https://chromewebstore.google.com/detail/ruffle-flash-emulator/donbcfbmhbcapadipfkeojnmajbakjdc'
      } else {
        if (os_version >= 5.0)
          install_url = 'https://chromewebstore.google.com/detail/ruffle-flash-emulator/donbcfbmhbcapadipfkeojnmajbakjdc'
...
function closeMsg(){
  ...
  LoadShardBlock: 233.324 (3)
  PetaboxLoader3.datanode: 240.098 (5)
  PetaboxLoader3.resolve: 597.593 (3)
  load_resource: 671.817 (2)
*/
